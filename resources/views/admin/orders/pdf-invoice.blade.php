...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
    		...
    		<div class="row" style="clear:both; margin-top: 100px;">
    			<div class="col-xs-6" style="float: left;">
    				<address>
    					...
    					<table class="table table-condensed" style="width:100%;">
    						...
    						<tbody>
    							...
    							@foreach($orderDetails->orders as $orderProduct)
									<tr>
										<td style="width:18%; text-align: center;">{{$orderProduct->product_code}}</td>
										<td style="width:18%; text-align: center;">{{$orderProduct->product_size}}</td>
										<td style="width:18%; text-align: center;">{{$orderProduct->product_color}}</td>
										<td style="width:18%; text-align: center;">{{$orderProduct->product_price}}</td>
										<td style="width:18%; text-align: center;">{{$orderProduct->product_quantity}}</td>
										<td style="width:18%; text-align: center;">{{$total = $orderProduct->product_price * $orderProduct->product_quantity }}</td>
									</tr>	
