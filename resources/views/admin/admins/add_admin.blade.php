...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Admin</a> <a href="#" class="current">Add Admin</a> </div>
    <h1>Add Admin</h1>
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{url('/admin/add-admin')}}" name="add_category" id="add_category" novalidate="novalidate">
                @csrf
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="checkbox" name="categories_view_access" id="categories_access" value="1" />
                  </div>
                  <label class="control-label">Categories Edit  Access</label>
                  <div class="controls">
                    <input type="checkbox" name="categories_edit_access" id="categories_access" value="1" />
                  </div>
