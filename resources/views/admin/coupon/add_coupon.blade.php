...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Coupon</a> <a href="#" class="current">Add Coupon</a> </div>
    <h1>Add Coupon</h1>
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{url('/admin/add-coupon')}}" name="add_coupon" id="add_coupon" enctype='multipart/form-data'>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="expiry_date" id="datepicker" autocomplete="off">
                  </div>
                </div>
                <div class="control-group">
